...
class TutsAddLocationScreen extends StatefulWidget {
  static const id = 'tuts_add_location_screen';

  @override
  _TutsAddLocationScreenState createState() => _TutsAddLocationScreenState();
}
