...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(howMany) => "${Intl.plural(howMany, zero: 'Nessuna foto selezionata', one: '1 foto selezionata', other: '${howMany} foto selezionate')}";

  static m2(number) => "Hai completato ${number} immagini giornaliere gratuite, vuoi continuare?";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "ask_photo_library_permission" : MessageLookupByLibrary.simpleMessage("Abbiamo bisogno di accedere alla tua libreria di foto in modo da poter iniziare a organizzare le tue foto con picPics. Non preoccuparti, i tuoi dati non lasceranno mai il tuo dispositivo!"),
