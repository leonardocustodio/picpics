...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(howMany) => Intl.plural(howMany, zero: '未选择照片', one: '已选择1张照片', other: '已选择${howMany}张照片');
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "ask_photo_library_permission":
            MessageLookupByLibrary.simpleMessage("我们需要访问您的照片库，以便您可以开始使用picPics整理照片。 不用担心您的数据将永远不会离开您的设备！"),
        ...
        "daily_challenge_permission_description":
            MessageLookupByLibrary.simpleMessage("为了让我们能够发送您的每日挑战，我们需要授权来发送通知，因此您需要在手机选项中授权通知权限"),
        ...
        "tutorial_multiselect": MessageLookupByLibrary.simpleMessage("您可以“点击并按住”照片以一次标记多张照片。"),
        "tutorial_secret": MessageLookupByLibrary.simpleMessage("用密码保护隐藏您的私人照片，以确保安全。"),
