...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "ask_photo_library_permission": MessageLookupByLibrary.simpleMessage(
            "我们需要访问您的照片库，以便您可以开始使用picPics整理照片。 不用担心您的数据将永远不会离开您的设备！"),
        "auto_renewable_first_part":
            MessageLookupByLibrary.simpleMessage("订阅为"),
        "auto_renewable_second_part":
            MessageLookupByLibrary.simpleMessage("自动续订。"),
        "cancel": MessageLookupByLibrary.simpleMessage("取消"),
        "cancel_anytime": MessageLookupByLibrary.simpleMessage("随时取消"),
        "close": MessageLookupByLibrary.simpleMessage("关闭"),
        "confirm_email":
            MessageLookupByLibrary.simpleMessage("确认您的注册电子邮箱以接收您的访问代码"),
        ...
        "device_has_no_pics":
            MessageLookupByLibrary.simpleMessage("此设备的图库中没有照片，因此没有可以添加标签的照片。"),
        ...
        "enable_faceid": MessageLookupByLibrary.simpleMessage("启用Face ID"),
        "enable_fingerprint": MessageLookupByLibrary.simpleMessage("启用指纹"),
        "enable_irisscanner": MessageLookupByLibrary.simpleMessage("启用虹膜扫描仪"),
        "enable_touchid": MessageLookupByLibrary.simpleMessage("启用Touch ID"),
        ...
        "gallery_access_permission":
            MessageLookupByLibrary.simpleMessage("访问权限"),
        ...
        "keep_safe": MessageLookupByLibrary.simpleMessage(
            "您的照片现在在picPics上是安全的。您要从相机胶卷中删除它吗？"),
        "language": MessageLookupByLibrary.simpleMessage("语言"),
        "lock_with_pin":
            MessageLookupByLibrary.simpleMessage("使用PIN密码锁定您的私人照片。"),
        ...
        "no_valid_subscription":
            MessageLookupByLibrary.simpleMessage("找不到有效的订阅购买。"),
        ...
        "organized_photos_description":
            MessageLookupByLibrary.simpleMessage("已添加标签的照片"),
        "organized_photos_title":
            MessageLookupByLibrary.simpleMessage("已整理的照片"),
        ...
        "photo_gallery_description":
            MessageLookupByLibrary.simpleMessage("尚未整理的照片"),
        ...
        "protect_with_encryption":
            MessageLookupByLibrary.simpleMessage("通过只能使用PIN密码进行访问的加密保护您的个人照片。"),
        ...
        "search_all_tags_not_found":
            MessageLookupByLibrary.simpleMessage("未找到带有所有标签的图片"),
        ...
        "tutorial_daily_package":
            MessageLookupByLibrary.simpleMessage("我们为您带来每日包，以逐步整理您的图库。"),
        "tutorial_however_you_want": MessageLookupByLibrary.simpleMessage(
            "通过添加标签（例如“家庭”、“宠物”或任何您想要的标签）来整理照片。"),
        "tutorial_just_swipe":
            MessageLookupByLibrary.simpleMessage("将标签添加到照片后，只需滑动即可前往下一个。"),
        "tutorial_multiselect":
            MessageLookupByLibrary.simpleMessage("您可以“点击并按住”照片以一次标记多张照片。"),
        "tutorial_secret":
            MessageLookupByLibrary.simpleMessage("用密码保护隐藏您的私人照片，以确保安全。"),
        "unlimited_private_pics":
            MessageLookupByLibrary.simpleMessage("无限的私人照片"),
        "vacation_tag": MessageLookupByLibrary.simpleMessage("假期"),
        "view_hidden_photos": MessageLookupByLibrary.simpleMessage(
            "要查看隐藏的照片，请在应用程序设置中释放锁。您可以用个人识别码解锁它们。"),
