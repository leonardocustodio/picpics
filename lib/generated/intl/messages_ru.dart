...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "ask_photo_library_permission" : MessageLookupByLibrary.simpleMessage("Нам нужен доступ к вашей фото-библиотеке, чтобы вы могли начать систематизировать свои фотографии с помощью picPics. Не волнуйтесь, ваши данные никогда не покинут ваше устройство!"),
    ...
    "tutorial_multiselect" : MessageLookupByLibrary.simpleMessage("Вы можете «нажать и удерживать» на своих фотографиях, чтобы отметить сразу несколько фотографий."),
    "tutorial_secret" : MessageLookupByLibrary.simpleMessage("Скройте свои личные фотографии с помощью защиты пин-кодом, сохраняя их в безопасности."),
