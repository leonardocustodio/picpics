...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(howMany) => Intl.plural(howMany,
      zero: '선택된 사진이 없습니다', one: '사진 1장이 선택됨', other: '사진 ${howMany}장이 선택됨');
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "ask_photo_library_permission": MessageLookupByLibrary.simpleMessage(
            "picPics로 사진 정리를 시작하려면 사진 라이브러리에 액세스해야합니다. 데이터가 장치를 떠나지 않을 것이라고 걱정하지 마십시오!"),
        "auto_renewable_first_part":
            MessageLookupByLibrary.simpleMessage("구독은"),
        "auto_renewable_second_part":
            MessageLookupByLibrary.simpleMessage("자동 갱신 가능."),
        "cancel": MessageLookupByLibrary.simpleMessage("취소"),
        "cancel_anytime": MessageLookupByLibrary.simpleMessage("언제든지 취소 가능"),
        "close": MessageLookupByLibrary.simpleMessage("닫기"),
        "confirm_email":
            MessageLookupByLibrary.simpleMessage("액세스 코드를 받으려면 등록 이메일을 확인하세요."),
        ...
        "device_has_no_pics": MessageLookupByLibrary.simpleMessage(
            "이 기기에는 갤러리에 사진이 없으므로 태그를 지정할 수 있는 사진이 없습니다."),
        "disable_secret":
            MessageLookupByLibrary.simpleMessage("이 사진의 숨김을 해제하시겠습니까?"),
        ...
        "enable_faceid": MessageLookupByLibrary.simpleMessage("Face ID 활성화"),
        "enable_fingerprint": MessageLookupByLibrary.simpleMessage("지문 활성화"),
        "enable_irisscanner":
            MessageLookupByLibrary.simpleMessage("홍채 스캐너 활성화"),
        "enable_touchid": MessageLookupByLibrary.simpleMessage("Touch ID 활성화"),
        "export_all_gallery":
            MessageLookupByLibrary.simpleMessage("모든 갤러리 내보내기"),
        ...
        "gallery_access_permission":
            MessageLookupByLibrary.simpleMessage("액세스 권한"),
        ...
        "keep_safe": MessageLookupByLibrary.simpleMessage(
            "이제 picPics에서 사진이 안전합니다. 카메라 롤에서 삭제하시겠습니까?"),
        "language": MessageLookupByLibrary.simpleMessage("언어"),
        "lock_with_pin":
            MessageLookupByLibrary.simpleMessage("PIN 암호로 개인 사진을 잠급니다."),
        ...
        "no_tagged_photos":
            MessageLookupByLibrary.simpleMessage("아직 태그된 사진이 없습니다"),
        "no_tags_found": MessageLookupByLibrary.simpleMessage("태그를 찾을 수 없습니다"),
        "no_valid_subscription":
            MessageLookupByLibrary.simpleMessage("유효한 구독 구매를 찾을 수 없습니다."),
        ...
        "organized_photos_description":
            MessageLookupByLibrary.simpleMessage("이미 태그된 사진"),
        "organized_photos_title":
            MessageLookupByLibrary.simpleMessage("정리된 사진"),
        ...
        "photo_gallery_description":
            MessageLookupByLibrary.simpleMessage("아직 정리되지 않은 사진"),
        ...
        "search_all_tags_not_found":
            MessageLookupByLibrary.simpleMessage("모든 태그가 있는 사진을 찾을 수 없습니다."),
        "search_results": MessageLookupByLibrary.simpleMessage("검색 결과"),
        "secret_key_created":
            MessageLookupByLibrary.simpleMessage("비밀 키가 생성되었습니다!"),
