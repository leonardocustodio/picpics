...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "view_hidden_photos" : MessageLookupByLibrary.simpleMessage("So zeigen Sie Ihre versteckten Fotos an., release the lock in the application settings. You can unlock them with your PIN."),
