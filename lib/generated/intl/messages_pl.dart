...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "all_at_once" : MessageLookupByLibrary.simpleMessage("Organizuj wiele zdjęć jednocześnie"),
    "all_photos_were_tagged" : MessageLookupByLibrary.simpleMessage("There are no more photos to organize."),
    "all_search_tags" : MessageLookupByLibrary.simpleMessage("Wszystkie tagi wyszukiwania"),
    "always" : MessageLookupByLibrary.simpleMessage("Zawsze"),
    "ask_photo_library_permission" : MessageLookupByLibrary.simpleMessage("Potrzebujemy dostępu do Twojej biblioteki zdjęć, abyś mógł zacząć porządkować swoje zdjęcia za pomocą picPics. Nie martw się, że Twoje dane nigdy nie opuszczą Twojego urządzenia!"),
    ...
    "confirm_email" : MessageLookupByLibrary.simpleMessage("Potwierdź swój e-mail rejestracyjny, aby otrzymać kod dostępu"),
    "confirm_secret_key" : MessageLookupByLibrary.simpleMessage("Potwierdź tajny klucz"),
    ...
    "disable_secret" : MessageLookupByLibrary.simpleMessage("Chcesz odkryć to zdjęcie?"),
    "dont_ask_again" : MessageLookupByLibrary.simpleMessage("Nie pytaj ponownie"),
    ...
    "enable_fingerprint" : MessageLookupByLibrary.simpleMessage("Włącz odcisk palca"),
    "enable_irisscanner" : MessageLookupByLibrary.simpleMessage("Włącz skaner tęczówki"),
    "enable_touchid" : MessageLookupByLibrary.simpleMessage("Włącz Touch ID"),
    ...
    "feedback_bug_report" : MessageLookupByLibrary.simpleMessage("Opinie i błędy"),
    "find_easily" : MessageLookupByLibrary.simpleMessage("Łatwo znajduj swoje zdjęcia"),
    "foods_tag" : MessageLookupByLibrary.simpleMessage("Foods"),
    "forgot_secret_key" : MessageLookupByLibrary.simpleMessage("Zapomniałeś tajnego klucza?"),
    ...
    "keep_safe" : MessageLookupByLibrary.simpleMessage("Twoje zdjęcie jest teraz bezpieczne na picPics. Czy chcesz go usunąć z rolki aparatu?"),
    "language" : MessageLookupByLibrary.simpleMessage("Język"),
    "lock_with_pin" : MessageLookupByLibrary.simpleMessage("Zablokuj swoje prywatne zdjęcia za pomocą kodu PIN."),
    "lock_your_photos" : MessageLookupByLibrary.simpleMessage("Zablokuj swoje zdjęcia"),
    "month" : MessageLookupByLibrary.simpleMessage("miesiąc"),
    "new_secret_key" : MessageLookupByLibrary.simpleMessage("Nowy tajny klucz"),
    ...
    "private_photos" : MessageLookupByLibrary.simpleMessage("Zdjęcia prywatne"),
    ...
    "search_all_tags_not_found" : MessageLookupByLibrary.simpleMessage("Nie znaleziono zdjęć ze wszystkimi tagami"),
    "search_results" : MessageLookupByLibrary.simpleMessage("Wyniki wyszukiwania"),
    "secret_key_created" : MessageLookupByLibrary.simpleMessage("Tajny klucz został pomyślnie utworzony!"),
    ...
    "tutorial_multiselect" : MessageLookupByLibrary.simpleMessage("Możesz „dotknąć i przytrzymać” swoje zdjęcia, aby oznaczyć tagami wiele zdjęć naraz."),
    "tutorial_secret" : MessageLookupByLibrary.simpleMessage("Ukryj swoje prywatne zdjęcia za pomocą kodu PIN, aby były bezpieczne."),
    "unlimited_private_pics" : MessageLookupByLibrary.simpleMessage("Nieograniczone prywatne zdjęcia"),
    "vacation_tag" : MessageLookupByLibrary.simpleMessage("Wakacje"),
    "view_hidden_photos" : MessageLookupByLibrary.simpleMessage("Aby wyświetlić ukryte zdjęcia, odblokuj w ustawieniach aplikacji. Możesz je odblokować za pomocą kodu PIN."),
    ...
    "your_secret_key" : MessageLookupByLibrary.simpleMessage("Twój tajny klucz")
  };
}
