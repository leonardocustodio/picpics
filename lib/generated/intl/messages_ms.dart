...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(howMany) => Intl.plural(howMany,
      zero: 'Tiada gambar yang dipilih', one: '1 gambar dipilih', other: '${howMany} gambar dipilih');

  static String m2(url) => "Untuk menguruskan semua gambar anda, pergi ke ${url}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "confirm_email":
            MessageLookupByLibrary.simpleMessage("Sahkan e-mel pendaftaran anda untuk menerima kod akses anda"),
        ...
        "no_valid_subscription":
            MessageLookupByLibrary.simpleMessage("Tidak dapat mencari pembelian langganan yang sah."),
        ...
        "search_all_tags_not_found":
            MessageLookupByLibrary.simpleMessage("Tiada gambar dijumpai dengan semua tag padanya"),
