...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(howMany) => "${Intl.plural(howMany, zero: 'Aucune photo sélectionnée', one: '1 photo sélectionnée', other: '${howMany} photos sélectionnées')}";

  static m2(number) => "Vous avez terminé vos ${number} photos quotidiennes gratuites, voulez-vous continuer ?";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "ask_photo_library_permission" : MessageLookupByLibrary.simpleMessage("Nous devons accéder à votre photothèque pour que vous puissiez commencer à organiser vos photos avec picPics. Ne vous inquiétez pas, vos données ne quitteront jamais votre appareil!"),
    ...
    "tutorial_multiselect" : MessageLookupByLibrary.simpleMessage("Vous pouvez «appuyer de manière prolongée» sur vos photos pour marquer plusieurs photos à la fois."),
    "tutorial_secret" : MessageLookupByLibrary.simpleMessage("Cachez vos photos privées avec une protection par code PIN pour les protéger."),
